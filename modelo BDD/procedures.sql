...
AS
SET NOCOUNT ON
if (select count(*) from RECIPE_ITEMS where ID_RECIPE_=@idRecipe and ID_MATERIAL=@idMaterial and ID_ITEM=@idItem)=0
	INSERT INTO RECIPE_ITEMS (ID_RECIPE_, ID_ITEM,ID_MATERIAL, QUANTITY_RECIPEMAT)
...
AS
SELECT ITEMS.ID_ITEM, RECIPE_ITEMS.ID_RECIPE_, MATERIALS_ITEMS.NAME_MATERIALS, RECIPE_ITEMS.QUANTITY_RECIPEMAT
...
AND RECIPE_ITEMS.ID_RECIPE_=@idRecipe
GO