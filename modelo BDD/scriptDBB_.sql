...
/* Created on:     06/11/2016 21:00:17                          */
/*==============================================================*/
...
/* Table: CODEPROVEEDOR                                         */
/*==============================================================*/
create table CODEPROVEEDOR (
   ID_CODPROVEDOR       int                  identity,
   ID_PRODUCT           int                  null,
   CODEPROVEEDOR        varchar(20)          null,
   DATE_CREATECODEPROVEDOR datetime             null,
   DATE_MODIFYCODEPROVEE datetime             null,
   STATUS_CODPROVEDOR   int                  null,
   DATE_DELETINGCODPROVE datetime             null,
   constraint PK_CODEPROVEEDOR primary key nonclustered (ID_CODPROVEDOR)
)
go
...
/* Index: PROD_FK                                               */
/*==============================================================*/
create index PROD_FK on CODEPROVEEDOR (
ID_PRODUCT ASC
)
go
...
alter table CODEPROVEEDOR
   add constraint FK_CODEPROV_PROD_PRODUCTS foreign key (ID_PRODUCT)
...
alter table RECIPE_ITEMS
   add constraint FK_RECIPE_I_RELATIONS_ITEMS foreign key (ID_ITEM)
      references ITEMS (ID_ITEM)
go
