...
@section('body')
    ...
    <form id="frmProduct" method="post" action="setAddProduct" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-xs-3">
                  <div class="form-group has-feedback">
                    <label for="Code Product">SKU</label>
                      <input type="text" name="txtCodeProduct" class="form-control" placeholder="SKU"  value="{{old('txtCodeProduct')}}" required="true" autocomplete="off" maxlength="20" />
                  ...
                  <div class="form-group has-feedback">
                    <label for="Code Product">Pack</label>
                      <input type="text" name="txtPack" id="txtPack" class="form-control" placeholder="Pack" onkeypress="return soloNumeros(event)" value="{{old('txtPack')}}" maxlength="100" required="true" autocomplete="off" readonly="true"/>
                ...
                <div class="col-xs-5 col-xs-offset-1">
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtNameProduct" class="form-control" placeholder="Name" value="{{old('txtNameProduct')}}" required="true" maxlength="100" autocomplete="off"/>
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtOnlineName" class="form-control" placeholder="Online name" value="{{old('txtOnlineName')}}" required="true" maxlength="100" autocomplete="off"/>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txtDescription" class="form-control" placeholder="Description" autocomplete="off" maxlength="100" />
                  </div>
                ...
                <div class="col-xs-3">
                  <div class="drag-drop">
                    ...
                    <input type="file" name="archivo" id="archivo" accept="image/*" required="true" onchange="loadImage()"/>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div class="container ">
              <div class="row">
                <hr>
                <div class="img-inbloom-Box">
                <div class="panel-inbloom has-feedback boxes ">
                  <div class="col-sm-5">
                    <h4>Box Materials </h4>
                  </div>
                  <div class="col-sm-5">
