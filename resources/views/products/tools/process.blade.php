        ...
        <div class="form-horizontal">
          <div class="form-group">
              ...
              <div class="inner-addon left-addon col-xs-2 col-sm-2">
                <button type="button" class="btn btn-inbloom" data-toggle="modal" data-target="#myRegister" onclick="setRegistros('','','setInsertProcess')">New register</button>
              </div>
            </div>
        </div>
    </article>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="#" data-toggle="modal" data-target="#myRegister" onclick="setRegistros('{{$datos->ID_PROCESS}}','{{$datos->TYPE_PROCESS}}','setModificationProcess')">Edit</a></li>
                        <li class="divider"></li>
                        <li><a href="#" data-toggle="modal" data-target="#myRegisterDel" onclick="setRegistrosDel('{{$datos->ID_PROCESS}}','{{$datos->TYPE_PROCESS}}','getDeleteProcess')">Delete</a></li>
                      </ul>
                    </div>
                  </td>
