        ...
        <div class="form-horizontal">
          <div class="form-group">
              ...
              <div class="inner-addon left-addon col-xs-2 col-sm-2">
                <button type="button" class="btn btn-inbloom" data-toggle="modal" data-target="#myRegister" onclick="setRegistros('','','setInsertBoxType')">Add</button>
              </div>
            </div>
        </div>
    </article>
          ...
          <tbody>
            <tr>
              @foreach ($tblDatos as $datos)
                <tr>
                  <td>{{$datos->ID_BTYPE}}</td> <td>{{$datos->TYPEBOXE_BTYPE}}</td> <td>{{$datos->DATECREATE_BTYPE}}</td>
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="#" data-toggle="modal" data-target="#myRegister" onclick="setRegistros('{{$datos->ID_BTYPE}}','{{$datos->TYPEBOXE_BTYPE}}','setModificationBoxType')">Edit</a></li>
                        <li class="divider"></li>
                        <li><a href="#" data-toggle="modal" data-target="#myRegisterDel" onclick="setRegistrosDel('{{$datos->ID_BTYPE}}','{{$datos->TYPEBOXE_BTYPE}}','getDeleteBoxType')">Delete</a></li>
                      </ul>
                    </div>
                  </td>
