        ...
        <div class="form-horizontal">
          <div class="form-group">
              ...
              <div class="inner-addon left-addon col-xs-2 col-sm-2">
                <button type="button" class="btn btn-inbloom" data-toggle="modal" data-target="#myRegister" onclick="setRegistros('','','setInsertCut')">New register</button>
              </div>
            </div>
        </div>
    </article>
          ...
          <tbody>
            <tr>
              @foreach ($tblDatos as $datos)
                <tr>
                  <td>{{$datos->ID_CUT}}</td> <td>{{$datos->NAME_CUT}}</td> <td>{{$datos->DATE_CUT}}</td>
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="#" data-toggle="modal" data-target="#myRegister" onclick="setRegistros('{{$datos->ID_CUT}}','{{$datos->NAME_CUT}}','setModificationCut')">Edit</a></li>
                        <li class="divider"></li>
                        <li><a href="#" data-toggle="modal" data-target="#myRegisterDel" onclick="setRegistrosDel('{{$datos->ID_CUT}}','{{$datos->NAME_CUT}}','getDeleteCut')">Delete</a></li>
                      </ul>
                    </div>
                  </td>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Cuts</h4>
        </div>
