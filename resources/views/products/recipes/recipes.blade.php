      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td> </td> <!--Datos de materiales-->
                <td>{{$dato->NAME_RECIPES}}</td><td>{{$dato->QUANTITY_RECIPES}}</td><td>{{$dato->DATECREATE_RECIPES}}</td><td>{{$dato->STATUS_RECIPES}}</td>
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="#" data-toggle="modal" data-target="#myRegister" >Edit</a></li>
                        <li class="divider"></li>
