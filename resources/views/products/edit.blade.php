              ...
              <div class="row">
                ...
                <div class="col-xs-3">
                  <div class="form-group has-feedback">
                    <label for="Code Product">SKU</label>
                      <input type="text" name="txtCodeProduct" class="form-control" placeholder="SKU"  value="{{$dtInformacion['infoProducto']->CODE_PRODUCT}}" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtCodeUpc"class="form-control" placeholder="UPC" value="{{$dtInformacion['infoProducto']->UPC_PRODUCT}}" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group has-feedback">
                    <label for="Code Product">Pack</label>
                      <input type="text" name="txtPack" id="txtPack" class="form-control" placeholder="Pack" onkeypress="return soloNumeros(event)" value="" required="true" autocomplete="off" readonly="true"/>
                ...
                <div class="col-xs-5 col-xs-offset-1">
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtNameProduct" class="form-control" placeholder="Name" value="{{$dtInformacion['infoProducto']->NAME_PRODUCT}}" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtOnlineName" class="form-control" placeholder="Online name" value="{{$dtInformacion['infoProducto']->ONLINENAME_PRODUCT}}" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txtDescription" class="form-control" placeholder="Description" autocomplete="off" value="{{$dtInformacion['infoProducto']->DESCRIPTION_PRODUCT}}"/>
                  </div>
              ...
              <div class="row">
                ...
                <div class="panel-inbloom has-feedback">
                  ...
                  <div class="btn-group col-sm-2">
                    ...
                    <button type="button" class="btn btn-default btn-md" data-toggle="collapse" data-target="#collapseRecipe" aria-expanded="false" aria-controls="collapseRecipe" onclick="getDataRecipes({{$dtInformacion['infoProducto']->ID_PRODUCT}})">
                      <span class="caret"></span>
                    </button>
                  </div>
