              ...
              <div class="row">
                ...
                <div class="col-xs-3">
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtCodeUpc"class="form-control" placeholder="UPC" value="{{$dtInformacion['infoProducto']->UPC_PRODUCT}}" maxlength="100" required="true" autocomplete="off"/>
                ...
                <div class="col-xs-5 col-xs-offset-1">
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtNameProduct" class="form-control" placeholder="Name" value="{{$dtInformacion['infoProducto']->NAME_PRODUCT}}" maxlength="100" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtOnlineName" class="form-control" placeholder="Online name" value="{{$dtInformacion['infoProducto']->ONLINENAME_PRODUCT}}" maxlength="100" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txtDescription" class="form-control" placeholder="Description" autocomplete="off" maxlength="100" value="{{$dtInformacion['infoProducto']->DESCRIPTION_PRODUCT}}"/>
                  </div>
                ...
                <div class="col-xs-3">
                  <div class="drag-drop">
                    ...
                    <input type="file" name="archivo" id="archivo" accept="image/jpeg" onchange="loadImage()"/>
                  </div>
                </div>
              </div>
          </div>
