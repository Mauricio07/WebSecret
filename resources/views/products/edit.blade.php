              ...
              <div class="row">
                ...
                <div class="col-xs-3">
                  <div class="form-group has-feedback">
                    <label for="Code Product">SKU</label>
                      <input type="text" name="txtCodeProduct" class="form-control" placeholder="SKU"  value="{{$datos['headProduct']->CODE_PRODUCT}}" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtCodeUpc"class="form-control" placeholder="UPC" value="{{$datos['headProduct']->UPC_PRODUCT}}" required="true" autocomplete="off"/>
                ...
                <div class="col-xs-5 col-xs-offset-1">
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtNameProduct" class="form-control" placeholder="Name" value="{{$datos['headProduct']->NAME_PRODUCT}}" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txtOnlineName" class="form-control" placeholder="Online name" value="{{$datos['headProduct']->ONLINENAME_PRODUCT}}" required="true" autocomplete="off"/>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txtDescription" class="form-control" placeholder="Description" value="{{$datos['headProduct']->DESCRIPTION_PRODUCT}}" autocomplete="off">
                  </div>
                ...
                <div class="tbl_hidden" id="divTblMaterial">
                  <table class="table" >
                    ...
                    <tbody id="tblMaterial">
                        @foreach ($datos['ProductMaterials_'] as $prodMat)
                          <tr id="ProdMat{{$prodMat->ID_PRODUCT}}">
                            <td>{{$prodMat->ID_PRODUCT}}</td><td>{{$prodMat->NAME_MATERIALS}}</td><td>{{$prodMat->QUANTITY_PRODMAT}}</td>
                            <td><div> <a href='#' class='btn delete' id='deletingMat' onclick=deleteItem("{{$prodMat->ID_PRODUCT}}",'ProdMat{{$prodMat->ID_PRODUCT}}','setDeleteMaterialsProd')></a></div></td>
                          </tr>
                        @endforeach
                    </tbody>
                  </table>
